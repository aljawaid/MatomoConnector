...
return array(
  ...
  'Use Apache version' => 'Use Apache version',
  'Don\'t use Apache version' => 'Don\'t use Apache version',
  'Instructions for Using Apache Version' => 'Instructions for Using Apache Version',
  'Bypass Adblockers Using Apache' => 'Bypass Adblockers Using Apache',
  'Cloaking or masking is a safe way to avoid detection by the filter lists used by Adblockers. It is up to you to be data-privacy compliant with your local regulations directly through' => 'Cloaking or masking is a safe way to avoid detection by the filter lists used by Adblockers. It is up to you to be data-privacy compliant with your local regulations directly through',
  'Apache module must be enabled on the server where your Matomo is installed.' => 'Apache module must be enabled on the server where your Matomo is installed.',
  'On your Matomo server, create or update your' => 'On your Matomo server, create or update your',
  'to include the following code:' => 'to include the following code:',
  'Source:' => 'Source:',
);
